    ...
    public class AccountController : Controller
    {
            ...
            try
            {
                if (userID != null)
                {
                    ...
                    else if (UserManager.IsInRole(userID, "Accountant"))
                    {
                        ...
                        return RedirectToAction("Dashboard", "FeeManagement");
                    }
        ...
        public JsonResult LogDurationDetail()
        {
            ...
            foreach (var item in teacherlist)
            {
                ...
                var count = db.AspNetLoginTimes.Where(x => x.UserId == item.UserId && x.StartTime.Month == DateTime.Now.Month).Count();
        ...
        public JsonResult UserLoginRecord(string type)
        {
            ...
            return Json(logindetails, JsonRequestBehavior.AllowGet);
        }
